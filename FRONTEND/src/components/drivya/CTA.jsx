    ...
    <Section>
      ...
      >
        ...
        <h2 className="font-display text-4xl md:text-6xl font-semibold tracking-tight text-foreground">
          Start storing <span className="text-gradient">smarter</span> with
          Drivya.
        </h2>
        <p className="mt-4 text-muted-foreground text-lg max-w-xl mx-auto leading-relaxed">
          Join hundreds of thousands of creators and teams already moving
          faster.
        </p>
        <Button
          size="lg"
          className="mt-8 bg-gradient-primary text-primary-foreground hover:opacity-90 shadow-glow group"
          asChild
        >
