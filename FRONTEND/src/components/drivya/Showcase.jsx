      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <h2 className="mt-3 font-display text-4xl md:text-5xl font-semibold tracking-tight">
            A workspace your{" "}
            <span className="text-gradient">files deserve.</span>
          </h2>
          <p className="mt-4 text-muted-foreground text-lg">
            Drivya replaces the messy stack of folders, attachments and chat
            threads with one beautifully fast home for everything you create.
          </p>
