  ...
  return (
    <div className="space-y-6">
      ...
      <SettingSection
        ...
        icon={Flag}
        title="Early Access"
        description="Opt into upcoming features before general availability."
      >
        <div className="px-6 py-3 space-y-2">
          {EARLY_ACCESS.map((feature) => (
            <div
              key={feature.id}
              className={`rounded-xl border p-4 transition-all duration-200 ${
                earlyAccess[feature.id]
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <SettingToggle
                  checked={earlyAccess[feature.id]}
                  onChange={() => toggleEarly(feature.id)}
                />
              </div>
            </div>
          ))}
      ...
      <SettingSection
        ...
        description="White-label the Drivya experience for your organization."
      >
        <SettingRow
          label="Custom Logo"
          description="Replace the Drivya logo in the sidebar and login page."
          tierRequired="Team"
        />
        <SettingRow
          label="Custom Favicon"
          description="Use your organization's favicon."
          tierRequired="Team"
        />
        <SettingRow
          label="Custom Domain"
          description="Use your own domain for shared link URLs (CNAME)."
          tierRequired="Team"
        />
      </SettingSection>
    </div>
