  ...
  return (
    <div className="space-y-6">
      ...
      <SettingSection
        ...
        description="Used for tax calculation and invoice generation."
      >
        ...
        <SettingRow label="ZIP / Postal Code">
          <SettingInput value="94107" placeholder="ZIP code" className="w-32" />
        </SettingRow>
      </SettingSection>

      {/* Seat Management teaser */}
      <SettingSection
        id="seats"
        icon={Users}
        title="Seat Management"
        description="Manage team member seats and roles."
      >
        <div className="px-6 py-5">
          <SettingBanner variant="info" icon={ArrowUpRight}>
            Seat management is available on the <strong>Team plan</strong>.
            Upgrade to add team members, set roles, and manage permissions.
          </SettingBanner>
          <button className="mt-3 inline-flex h-9 items-center gap-2 rounded-xl bg-gradient-primary px-4 text-xs font-semibold text-primary-foreground shadow-glow hover:opacity-90 transition-opacity">
            <ArrowUpRight className="h-3.5 w-3.5" />
            Upgrade to Team
          </button>
        </div>
