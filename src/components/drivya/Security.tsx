...
const items = [
  { icon: Lock, title: "End-to-end encryption", desc: "AES-256 at rest, TLS 1.3 in flight, zero-knowledge keys." },
  { icon: Server, title: "Secure cloud backups", desc: "Geo-redundant snapshots across 3 regions, every 6 hours." },
  { icon: Shield, title: "Privacy-focused", desc: "GDPR & SOC 2 Type II certified. We never train on your data." },
  { icon: KeyRound, title: "Advanced protection", desc: "SSO, SCIM, audit logs, 2FA and per-link passwords." },
];
