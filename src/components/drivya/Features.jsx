...
const features = [
  {
    ...
    desc: "Drop hundreds of files at once. Resumable, parallelized, blazing fast.",
  },
  {
    icon: FolderTree,
    title: "Smart File Organization",
    desc: "Auto-tagging and folders that stay tidy without lifting a finger.",
  },
  {
    icon: Share2,
    title: "Secure File Sharing",
    desc: "Share links with passwords, expirations and granular permissions.",
  },
  {
    icon: Search,
    title: "Instant Search",
    desc: "Find any file in milliseconds — search inside docs, images and PDFs.",
  },
  {
    icon: RefreshCw,
    title: "Multi-device Sync",
    desc: "Mac, Windows, iOS, Android, Web. Always in sync, always offline-ready.",
  },
  {
    icon: Activity,
    title: "Real-time Progress",
    desc: "Live upload telemetry with bandwidth, ETA and per-file detail.",
  },
  {
    icon: Eye,
    title: "Fast File Preview",
    desc: "Open and stream 100+ formats without downloading a single byte.",
  },
  {
    icon: Cpu,
    title: "AI-ready Infrastructure",
    desc: "Pipe storage into your models with first-class API and webhooks.",
  },
];
